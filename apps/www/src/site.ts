...
export const SITE_DESCRIPTION =
  "The open-source Grok Bot alternative. Run persistent AI teammates with their own computer, memory, and routines — using your keys, your model, on your machine.";
