...
const HOME_COPY: Record<Locale, HomeCopy> = {
  ...
  zh: {
    ...
    selfHost: {
      eyebrow: "自托管",
      heading: "电脑归你所有",
      copy: "使用发布镜像在你自己的机器上运行 Rakazo。本地 Docker 电脑无需 E2B 账户即可工作。",
      installTitle: "使用 Docker 安装",
      installHint: "需要 Docker Engine 和 Compose 插件。默认标签为 edge（amd64）。",
      computersNote:
        "默认使用本机上的 Docker 电脑。E2B、Daytona 和 Box 是可选的远程提供商。",
      features: [
        {
          title: "任意模型，密钥归你",
    ...
    getStartedDialog: {
      ...
      eyebrow: "开始使用",
      title: "你想如何开始？",
      copy: "现在用 Docker 自托管，或加入云端候补名单。",
      selfHostNow: "立即自托管",
      selfHostHint: "发布镜像。几分钟上手。注册无需 E2B 密钥。",
